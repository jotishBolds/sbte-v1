    ...
    const photoProducts: PhotoProduct[] = [
        {
            ...
            image: "/assets/frames/classic.png",
            description:
                "Elevate your memories with our timeless photo frames crafted from premium materials to complement any decor style",
            link: "/products/classic-photo-frames",
            isBestseller: true,
        },
        {
            id: 2,
            title: "Photo Wall Display",
            image: "/assets/frames/wall-display.png",
            description:
                "Create stunning gallery walls with our perfectly coordinated frame collections designed for harmonious arrangement",
            link: "/products/photo-wall-display",
        },
        {
            id: 3,
            title: "Split Photo Frames",
            image: "/assets/frames/split.png",
            description:
                "Transform panoramic views and wide-angle shots into captivating multi-frame displays that command attention",
            link: "/products/split-photo-frames",
        },
        {
            id: 4,
            title: "Photo Tiles",
            image: "/assets/frames/tiles.png",
            description:
                "Reinvent your space with our innovative, adhesive photo tiles that allow for endless creative arrangements",
            link: "/products/photo-tiles",
        },
    ];

    const features = [
        "Museum-grade matting and UV-protective glass to preserve image quality",
        "Precision-crafted frames in solid wood, metal, and acrylic options",
        "Professional-quality printing on archival paper for exceptional depth",
        "Customizable sizing and matting to perfectly showcase any image",
        "Versatile hanging hardware for both portrait and landscape orientations",
    ];
                ...
                <div className="container mx-auto px-4 sm:px-6">
                    ...
                    <div className="mb-10">
                        <p className="text-gray-700 mb-6 text-base md:text-lg leading-relaxed">
                            Our Photo Frame Collection combines traditional
                            craftsmanship with contemporary design to create the
                            perfect showcase for your most treasured memories.
                            Each frame is meticulously crafted from premium
                            materials and finished with precision to enhance
                            your photographs while complementing your interior
                            design. From minimalist modern styles to ornate
                            classic designs, our diverse selection ensures the
                            perfect match for any image and environment.
                        </p>

                        <div className="mt-8">
                            <h2 className="text-xl md:text-2xl font-semibold mb-6 text-[#333333] border-l-4 border-[#4a9936] pl-4">
                                The Photo Frame Advantage
                            </h2>
