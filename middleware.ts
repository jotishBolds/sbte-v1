...
const protectedRoutes: { [key: string]: string[] } = {
  ...
  "/api/gradeCard/importInternal": ["COLLEGE_SUPER_ADMIN"],
  "/api/gradeCard": ["COLLEGE_SUPER_ADMIN"],
  "/api/subjectGradeDetail": ["COLLEGE_SUPER_ADMIN"],
  "/post-external-marks": ["COLLEGE_SUPER_ADMIN"],
  "/post-grade-details": ["COLLEGE_SUPER_ADMIN"],
  "/api/gradeCard/generateGradeDetails": ["COLLEGE_SUPER_ADMIN"],
  "/import-internal": ["COLLEGE_SUPER_ADMIN"],
  "/teacher-designation": ["COLLEGE_SUPER_ADMIN"],
  "/student-register": ["COLLEGE_SUPER_ADMIN"],
  "/api/admissionYear": ["COLLEGE_SUPER_ADMIN"],
  "/placeholder-avatar.png": ["COLLEGE_SUPER_ADMIN"],
  // Super Admin
  ...
  "/api/eligibilityList": ["SBTE_ADMIN","COLLEGE_SUPER_ADMIN"],
  "/view-infrastructure": ["SBTE_ADMIN"],
  "/view-schedules": ["SBTE_ADMIN"],
  "/api/schedules": ["SBTE_ADMIN", "COLLEGE_SUPER_ADMIN"],
  ...
  "/templates/internal_marks_template.xlsx": ["COLLEGE_SUPER_ADMIN"],
  "/student-list": ["COLLEGE_SUPER_ADMIN"],
  "/yes": ["COLLEGE_SUPER_ADMIN"],
  "/student-subjects": ["COLLEGE_SUPER_ADMIN"],
  "/subject-type": ["COLLEGE_SUPER_ADMIN"],
  "/api/examType": ["COLLEGE_SUPER_ADMIN"],
  "/api/examMarks": ["COLLEGE_SUPER_ADMIN"],
  "/templates/exam_marks_template.xlsx": ["COLLEGE_SUPER_ADMIN"],
  "/alumni-list": ["COLLEGE_SUPER_ADMIN"],
  "/api/alumni/dept": ["COLLEGE_SUPER_ADMIN"],
  "/api/alumni": ["COLLEGE_SUPER_ADMIN"],
  "/feedbacks-list": ["COLLEGE_SUPER_ADMIN"],
  "/api/feedback": ["COLLEGE_SUPER_ADMIN"],
  "/api/fetchActiveDepartments": ["COLLEGE_SUPER_ADMIN"],
