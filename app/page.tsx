              ...
              <motion.div key={index} whileHover={{ y: -8 }}>
                <Card className="shadow-lg hover:shadow-2xl transition-all">
                  <CardContent className="p-6 text-center">
                    ...
                    <p className="text-gray-600 mt-3">{profile.description}</p>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
            ...
            <Tabs defaultValue="about" className="w-full">
              ...
              <TabsContent value="about" className="mt-6">
                <Card className="shadow-md border-t-4 border-green-600">
                  <CardHeader>
                    <CardTitle className="text-green-700">About SBTE</CardTitle>
                  </CardHeader>

                  <CardContent className="space-y-4 text-gray-700 leading-relaxed">
                    <p>
                      The State Board of Technical Education (SBTE) was
                      constituted in 2002 to advise the State Government on all
                      matters related to technical education.
                    </p>

                    <p>
                      Currently, the state has government-run technical
                      institutes affiliated under SBTE which oversee academic
                      and diploma certification activities.
                    </p>
                    ...
                    <div className="space-y-3 mt-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p>
                          <span className="font-semibold">
                            Centre for Computers & Communication Technology
                            (CCCT)
                          </span>{" "}
